 ...
 */
public abstract class BaseAdapter_r<T, VH extends BaseAdapter_r.ViewHolder> extends android.widget.BaseAdapter {

    private Context context;
    ArrayList<T> data;

    public BaseAdapter_r(ArrayList<T> data) {
     ...
     * @param itemViewType adapter 会根据{@link BaseAdapter_r#multiItemEnable()}自动选择
     ...
     * see{@link BaseAdapter_r#getAdapterViewTypeCount()}
     *
     * @return item 数量
     */
    @Override
